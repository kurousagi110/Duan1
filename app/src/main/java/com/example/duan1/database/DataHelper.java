...
public class DataHelper extends SQLiteOpenHelper {
    public DataHelper( Context context) {
        super(context, "ThuChiDatabase", null, 11);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String khoanthuchi = "INSERT INTO KHOANTHUCHI VALUES(1, 6000, '2022/01/03' ,1), (2, 5000, '2022/01/04', 3), (3, 10000, '2022/01/06',2)";
        db.execSQL(khoanthuchi);

        String khoanthuchi1 = "INSERT INTO KHOANTHUCHI VALUES(4, 5000, '2022/11/01' ,6), (5, 7000, '2022/11/09', 5), (6, 1000, '2022/11/10',4)";
