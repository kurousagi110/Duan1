...
public class DataHelper extends SQLiteOpenHelper {
    public DataHelper( Context context) {
        super(context, "ThuChiDatabase", null, 27);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        String qTaiKhoan = "CREATE TABLE TAIKHOAN (soTK integer primary key autoincrement, taikhoan text,sodt text, matkhau text)";
        ...
        db.execSQL(qKhoan);
        //data mẫu:
        String taikhoan = "INSERT INTO TAIKHOAN VALUES(1, 'admin','0123456789', 'admin'), (2, 'hoa123','0123456789', '123'), (3, 'tai456','0123456789', '456'), (4, 'loi789','0123456789', '789')";
        db.execSQL(taikhoan);
